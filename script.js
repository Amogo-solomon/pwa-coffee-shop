...
document.addEventListener("DOMContentLoaded", function () {
  ...
  request.onupgradeneeded = function (event) {
    ...
    const checkoutDataStore = db.createObjectStore("checkoutData", {
      autoIncrement: true,
    });
  };
...
//           registration.sync.register("checkoutDataSync")
//         );
//       })
//       .catch(function (err) {
...
function displayCartItem(item) {
  ...
  const cartItemHTML = `
        <div class="cart-item">
            <span class="fas fa-times" onclick="removeCartItem('${
              item.name
            }')"></span>
            <div class="content">
                <h3>${item.name}</h3>
    ...
    registration.pushManager
      .subscribe({
        ...
        applicationServerKey: urlBase64ToUint8Array(
          "BFgxZbP36JNCyaRVWmyQ0pl_M_cPA1QLzBSlvLV9faQQ_38zx9S_TBAHrhLuMGtDtIR2KcI8uNNm5uUqTlGU5cY"
        ),
      })
